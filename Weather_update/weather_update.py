...
import sys
spec = importlib.util.spec_from_file_location("fill", "D:/test_development/Weather/Weather_missing/weather_missing.py")
weather_missing = importlib.util.module_from_spec(spec)
sys.modules["fill"] = weather_missing
...
def update():
  ...
  #-------------------------------------------------------------------------------------------
  #file_path = 'data/'
  file_path = 'D:/test_development/Weather/Weather_update/data/'
